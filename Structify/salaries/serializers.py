...
class SalarySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Salary
        fields = "__all__"
        read_only_fields = ["created_by","modified_by","created_at","updated_at","deleted_by","deleted_at","is_deleted"]
...
class SalaryCreateUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Salary
        fields = [
            "employee", "basic_salary", "allowances", "deductions", "net_salary",
        ...
        def validate(self, data):
            ...
            if data["net_salary"] != data["basic_salary"] + data["allowances"] - data["deductions"]:
                raise serializers.ValidationError("Net salary does not match the expected calculation: basic + allowances - deductions.")
            return data
